        ...
        <div className="max-w-6xl mx-auto mt-8 py-4 px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col justify-top items-center">
            <p className="flex text-[18px] font-semibold text-yellow-500 mb-4">Follow DProject</p>
              ...
              <Link target="_blank" href="https://3kv215.dfi.fund/templates/index.html"><p className="text-[20px] font-bold mt-4"><span className="text-red-500">Kok</span><span className="text-yellow-500">Kok</span><span className="text-green-500">Kok</span><sup className="text-[10px] font-bold">TM</sup></p></Link>
